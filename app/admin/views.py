...
def maintenance():
    ...
    return render_template('administration/maintenance-requests.html', request=main.getRequest(0), form=form, completed=main.getRequest(1))
...
def event():
    ...
    return render_template('administration/event-request.html',form=form, request = event.getRequest(), past=event.getPastEvents())
